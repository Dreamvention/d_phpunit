...
class OpenCartTest extends TestCase
{
    ...
    public static function loadConfiguration()
    {
        ...
        if (substr($_SERVER['OC_ROOT'], -1) != DIRECTORY_SEPARATOR) {
            putenv('OC_ROOT=' . $_SERVER['OC_ROOT'] . DIRECTORY_SEPARATOR);
        }

        $config_path = $_SERVER['OC_ROOT'] . (self::isAdmin() === false ? '' : 'admin/') . 'config.php';
    ...
    /**
     * Request a action to OpenCart and return object of response
     *
     * @param string $route
